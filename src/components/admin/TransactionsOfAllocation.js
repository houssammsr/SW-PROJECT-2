...
const TransactionsOfAllocation111 = () => {
              ...
              <div className="balancecontainer">
                ...
                <div className="balance">
                  <div className="amount-and-dzd-container6">
                    ...
                    <div className="total-allocated-balance">DZD</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="t-head1">
                ...
                <div className="amount-title1">
                  <div className="amount-and-dzd-container6">
                    ...
                    <div className="transaction-id-var6">DZD</div>
                  </div>
                </div>
              </div>
              <div className="t-head1">
...
export default TransactionsOfAllocation111;
